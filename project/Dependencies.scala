...
object Dependencies {
  ...
  lazy val logback          = "ch.qos.logback"       % "logback-classic"   % "1.3.0-alpha5"
  ...
  lazy val vcr4jSharktopoda = "org.mbari.vcr4j"      % "vcr4j-sharktopoda" % "4.4.0.jre11-SNAPSHOT"
  lazy val vcr4jSharkClient =
    "org.mbari.vcr4j" % "vcr4j-sharktopoda-client" % "4.4.0.jre11-SNAPSHOT"
}
